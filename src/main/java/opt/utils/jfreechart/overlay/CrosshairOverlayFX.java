...
import opt.utils.jfreechart.ChartCanvas;
...
public class CrosshairOverlayFX extends CrosshairOverlay implements OverlayFX {
    ...
    public void paintOverlay(Graphics2D g2, ChartCanvas chartCanvas) {
        ...
        org.jfree.ui.RectangleEdge xAxisEdge = plot.getDomainAxisEdge();
        ...
        org.jfree.ui.RectangleEdge yAxisEdge = plot.getRangeAxisEdge();
