...
public class ControlFactory {
	...
	public static ControllerRampMeterAlinea create_controller_alinea(float dt, float start_time, Float end_time, Collection<Long> link_ids, FreewayScenario fwyscn) throws Exception {
...
//		}
		...
		ControllerRampMeterAlinea ctrl = new ControllerRampMeterAlinea(fwyscn.new_controller_id(),dt,start_time,end_time);
		scenario.add_controller(ctrl);
		return ctrl;
	}

	public static ControllerRampMeterTOD create_controller_tod(float dt, float start_time, Float end_time, Collection<Long> link_ids, FreewayScenario fwyscn) throws Exception {
...
//		}
		...
		ControllerRampMeterTOD ctrl = new ControllerRampMeterTOD(fwyscn.new_controller_id(),dt,start_time,end_time);
		scenario.add_controller(ctrl);
		return ctrl;
	}
