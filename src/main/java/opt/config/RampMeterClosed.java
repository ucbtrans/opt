...
public class RampMeterClosed {
    ...
    public void initWithLinkAndController(AbstractLink lnk, ControlSchedule schedule, ScheduleEntry entry, boolean isnew) {
        myLink = lnk;
        mySchedule = schedule;
        myController = (ControllerRampMeterClosed) entry.get_cntrl();
        this.isnew = isnew;
